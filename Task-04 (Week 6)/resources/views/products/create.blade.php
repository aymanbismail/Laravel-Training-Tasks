...
<div class="container" style="max-width: 800px;">
  <div class="card">
    <h1 style="color: #1f2937; margin-bottom: 20px; font-size: 24px; font-weight: 700;">Create New Product</h1>
          ...
          <div class="supplier-fields" id="supplier_fields_{{ $supplier->id }}"
            ...
            <div>
              ...
              <input type="number" id="cost_price_{{ $supplier->id }}" name="suppliers[{{ $supplier->id }}][cost_price]"
                step="0.01" min="0" value="{{ old(" suppliers.{$supplier->id}.cost_price") }}"
            ...
            <div>
              ...
              <input type="number" id="lead_time_{{ $supplier->id }}"
                name="suppliers[{{ $supplier->id }}][lead_time_days]" min="0" value="{{ old("
                suppliers.{$supplier->id}.lead_time_days") }}"
